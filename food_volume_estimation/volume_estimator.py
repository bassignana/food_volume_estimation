...
class VolumeEstimator():
    ...
    def __parse_args(self):
        ...
        parser.add_argument('--input_images', type=str, nargs='+',
                            ...
                            default='/Users/tommasobassignana/Desktop/food_volume_estimation-master/assets/readme_assets/examples/rice_example.png')
        parser.add_argument('--depth_model_architecture', type=str,
                            help=('Depth estimation model '
                                  'architecture (.json).'),
                            metavar='/path/to/architecture.json',
                            default='/Users/tommasobassignana/Desktop/food_volume_estimation-master/models/monovideo_fine_tune_food_videos.json')
        parser.add_argument('--depth_model_weights', type=str,
                            help='Depth estimation model weights (.h5).',
                            metavar='/path/to/weights.h5',
                            default='/Users/tommasobassignana/Desktop/food_volume_estimation-master/models/monovideo_fine_tune_food_videos.h5')
        parser.add_argument('--segmentation_weights', type=str,
                            help='Food segmentation model weights (.h5).',
                            metavar='/path/to/weights.h5',
                            default='/Users/tommasobassignana/Desktop/food_volume_estimation-master/models/mask_rcnn_food_segmentation.h5')
    ...
    def estimate_volume(self, input_image, fov=70,  plate_diameter_prior=0.3,
        ...
        input_image = '/Users/tommasobassignana/Desktop/food_volume_estimation-master/assets/readme_assets/examples/rice_example.jpg'

        if isinstance(input_image, str):
            #img = cv2.imread(input_image, cv2.IMREAD_COLOR)
            print(input_image)
            img = cv2.imdecode(np.fromfile(input_image, dtype=np.uint8), cv2.IMREAD_COLOR)
            print(img)
        else:
            img = input_image
...
if __name__ == '__main__':
    ...
    volumes = estimator.estimate_volume(
        '/Users/tommasobassignana/Desktop/food_volume_estimation-master/assets/readme_assets/examples/rice_example.jpg', estimator.args.fov, 
